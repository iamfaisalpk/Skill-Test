...
export default function ProductCard({ product, defaultColor }: Props) {
    ...
    return (
        ...
        >
            ...
            {/* Hover content: Size, Color, Buy Now */}
            <div
                ref={infoRef}
                    ...
                    <div className="flex justify-center gap-2">
                        {AVAILABLE_SIZES.map((size) => (
                            <button
                                ...
                                className={`w-12 h-12 rounded-md font-bold text-base transition-all duration-200 ${
                                    selectedSize === size
                                        ? "bg-white text-black"
                    ...
                    <div className="flex justify-center gap-2">
                        {(["green", "vilot", "red"] as ColorKey[]).map((color) => (
                            <button
                                ...
                                className={`w-6 h-6 rounded-full ${COLOR_SWATCH[color]} transition-all duration-200 ${
                                    selectedColor === color
