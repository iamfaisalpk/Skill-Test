                            ...
                            return (
                                ...
                                >
                                    <button
                                        ...
                                        className="absolute cursor-pointer top-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-3 bg-red-600 hover:bg-red-700 rounded-full"
                    ...
                    <div className="bg-gray-900 rounded-2xl p-8 max-w-sm w-full shadow-2xl">
                        ...
                        <div className="mb-6 flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm">{orderToDelete.variation_details}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className="flex-1 py-3 rounded-xl border cursor-pointer border-gray-600 hover:bg-gray-800 transition"
                            >
                                Cancel
                            </button>
                            <button
                                onClick={handleDelete}
                                className="flex-1 py-3 rounded-xl cursor-pointer bg-red-600 hover:bg-red-700 transition font-medium"
                            >
                                Delete Order
                            </button>
                        </div>
